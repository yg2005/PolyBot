...
class KalbotConfig(BaseModel):
    ...
    polymarket_wallet_address: str = Field(default="", repr=False)
    polymarket_proxy_wallet: str = Field(default="", repr=False)   # Google/Magic proxy wallet — pass as wallet= to SecureClient
